...
const config = {
  "generator": {
    ...
    "output": {
      "value": "F:\\carole-admin\\server\\src\\common\\prisma-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "933e2b34bf771233a0d10e6077fa727a95ab4e18a6108c8a85ce3dc0defc6e94",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/common/prisma-client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
